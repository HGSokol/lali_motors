        ...
        <div className={style.sectionContainer}>
          <div className={style.titleContainer}>
            ...
            <div className={style.flame3}>
              <Flame width={57} opacity={0.8} />
            </div>
            <div className={style.flame4}>
              <Flame width={49} opacity={0.8} />
            </div>
            <div className={style.flame5}>
              <Flame width={80} opacity={0.8} />
            </div>
          </div>
          <div className={style.infoContainer}>
            <div className={style.infoWrapper}>
              <span className={style.infoTitle}>
                Эксклюзивные премиум-автомобили для тех, кто ценит стиль и
                статус. Мы поможем вам выбрать автомобиль, который станет
                отражением вашей личности.
              </span>
